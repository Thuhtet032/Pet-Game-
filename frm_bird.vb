...
Public Class frm_bird
    ...
    Private Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        ' select a pet type
        Dim petType As String = Form1.type 'InputBox("Enter the type of the pet (Mouse, Bird, Tiger):")
        'If String.IsNullOrEmpty(petType) Then
        'MessageBox.Show("Please enter a valid pet type!")
        'Return
        'End If
